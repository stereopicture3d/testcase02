...
//	Date		Version	Dev	Description
// 	2020 May 22 	.2xa	WC	Menu size changes, hide Menu on Fullscreen
// 	2020 May 29 	.2xb	EC	Keyboard shortcuts for modes- Toggle All, Toggle SBS/SBS50, Interlace
//      2020 May 29     .2xc    WC      Keyboard shortcuts for modes- Use 0-9 on NumPad to select
//      2020 May 29     .2xd    WC      Changed numpad selection order to 1-9,0 to make sbs50 more prominent
//      2020 June 14    .2xe    WC      Changed color of text to make it a little more visible
...
"    <ul>",
"      <li><button id='button20' style='height:20px;width:60px;'>Para</button></li> ",
"      <li><button id='button21' style='height:20px;width:60px;'>Cross</button></li> ",
"      <li><button id='button22' style='height:20px;width:60px;'>Dubois</button></li> ",
"      <li><button id='button29' style='height:20px;width:60px;'>SPM_Ana.</button></li> ",
"      <li><button id='button23' style='height:20px;width:60px;'>C_Ana.</button></li> ",
"      <li><button id='button24' style='height:20px;width:60px;'>Ana.</button></li> ",
"      <li><button id='button25' style='height:20px;width:60px;'>Int.</button></li> ",
"      <li><button id='button26' style='height:20px;width:60px;'>V_Int.</button></li> ",
"      <li><button id='button27' style='height:20px;width:60px;'>Single</button></li> ",
"      <li><button id='button28' style='height:20px;width:60px;'>SBS50</button></li> ",
"    </ul>",
"  </li>",
"  <li><button id='button31'>Slide</button>",
"    <ul>",
"      <li><button id='button40' style='height:20px;width:60px;'>Off</button></li> ",
"      <li><button id='button41' style='height:20px;width:60px;'>1 Sec.</button></li> ",
"      <li><button id='button42' style='height:20px;width:60px;'>2 Sec.</button></li> ",
"      <li><button id='button43' style='height:20px;width:60px;'>3 Sec.</button></li> ",
"      <li><button id='button44' style='height:20px;width:60px;'>4 Sec.</button></li> ",
"      <li><button id='button45' style='height:20px;width:60px;'>5 Sec.</button></li> ",
"      <li><button id='button46' style='height:20px;width:60px;'>6 Sec.</button></li> ",
"      <li><button id='button47' style='height:20px;width:60px;'>7 Sec.</button></li> ",
"      <li><button id='button48' style='height:20px;width:60px;'>8 Sec.</button></li> ",
"      <li><button id='button49' style='height:20px;width:60px;'>9 Sec.</button></li> ",
"    </ul>",
"  </li>",
...
"    <ul>",
"      <li><button id='button6' style='height:20px;width:60px;'> Fit </button></li> ",
"      <li><button id='button7' style='height:20px;width:60px;'> + </button></li> ",
"      <li><button id='button5' style='height:20px;width:60px;'> - </button></li> ",
"    </ul>",
"  </li>",
...
"    <ul>",
"      <li><button id='button50' style='height:20px;width:60px;'> Japanese </button></li> ",
"      <li><button id='button51' style='height:20px;width:60px;'> English </button></li> ",
"      <li><button id='button52' style='height:20px;width:60px;'> Version </button></li> ",
"    </ul>",
"  </li>",
...
function KeyEvent(e){
	...
	draw();
     ...
     stype=stype=0 //false, switch to SBS
     }
	draw();
	}
...
function draw2(){
	...
	else {nWinheight = getBrowserHeight()-0;}
